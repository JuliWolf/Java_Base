...
Метод возвращает новую измененную коллекцию
...
Метод для фильтрации элементов коллекции
...
Метод для перебола элементов коллекции, полный аналог for
...
Метод reduce это некоторое сочетание методов `map` и `filter`
С его помощью можно изменить структуру коллекции, отфильтровать и изменить коллекцию 

1. Reduce первым аргументом может принимать начальное значение аккумулятора
2. Если начальное значение аккумулятора не задано, но начальным значением будет являться первый элемент коллекции
...
## Применение методов на других коллекциях
