...
### 13. Как определить причину OutOutMemoryError
...
+ [9. Какие ошибки отменяют транзакцию?](#9-какие-ошибки-отменяют-транзакцию)
+ [10. Как удалить все записи из таблицы](#10-как-удалить-все-записи-из-таблицы)
+ [11. Как работает while loop](#11-как-работает-while-loop)
...
### 9. Какие ошибки отменяют транзакцию?
Error

### 10. Как удалить все записи из таблицы
...
+ [15. ReentrantReadWriteLock](#15-reentrantreadwritelock)
+ [16. Semaphore](#16-semaphore)
+ [17. CountDawnLatch](#17-countdawnlatch)
+ [18. CyclicBarrier](#18-cyclicbarrier)
+ [19. Классы для работы с коллекциями внутри потоков](#19-классы-для-работы-с-коллекциями-внутри-потоков)
...
### 19. Классы для работы с коллекциями внутри потоков
- `ArrayBlockingQueue`
...
### 20. Классы для создания синхронизирующих точек
- `CountDownLatch`
- `CyclicBarrier`
- `Exchanger`
- `Phaser`
...
### 22. Чем отличается Runnable от Callable
| Runnable                                                                                 | Callable                                                                         |
|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
...
+ [9. Из чего состоит](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
+ [10. Жизненный цикл сообщений](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
+ [11. Как долго kafka хранит сообщения](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
+ [12. Какая структура сообещения Kafka](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
+ [13. Как организованы и как хранятся сообщения](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
+ [14. Как организованы Партиции](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
+ [15. Что такое consumer group](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
+ [16. Каким образом обозначить сообщения в партиции, как обработанные](#8-как-настроить-отправку-только-одного-сообщения-exactly-one-)
