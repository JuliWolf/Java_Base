...
+ [2. Java](#2-java)
  ...
  + [2.1. Основы](#21-основы)
  	...
  	+ [2.1.6. Что такое JIT-компилятор?](#216-что-такое-jit)
    ...
    + [2.2. Примитивные типы, строки и базовые структуры](#22-примитивные-типы-строки-и-базовые-структуры)
      <details>
        ...
        + [2.2.4. Что такое классы-обертки (Wrapper classes)?](#224-что-такое-классы-обертки)
        + [2.2.5. Что такое приведение типов (cast)?](#225-что-такое-приведение-типов-cast)
        + [2.2.6. Что такое пул интов (Integer pool)?](#226-что-такое-пул-интов)
        + [2.2.7. Какие нюансы у строк в Java?](#227-какие-нюансы-у-строк-в-java)
        + [2.2.8. Что такое пул строк (String pool)?](#228-что-такое-пул-строк)
        ...
        + [2.2.10. Почему класс String неизменяемый (immutable) и final?](#2210-почему-класс-string-неизменяемый-и-final)
        ...
        + [2.2.14. В чем разница между String, StringBuffer и StringBuilder?](#2214-в-чем-разница-между-string-stringbuffer-stringbuilder)
        + [2.2.15. Каким образом переменные передаются в методы (pass-by-value vs pass-by-reference)?](#2215-каким-образом-переменные-передаются-в-методы)
        ...
        + [2.2.19. Какие классы могут быть статическими (static nested classes)?](#2219-какие-классы-могут-быть-статическими)
        ...
        + [2.2.24. Как проверить значение на null в Java 8+ (Optional, etc.)?](#2224-как-проверить-значение-на-null-в-java-8)
    ...
    + [2.4. Объектно-ориентированное программирование (ООП)](#24-объектно-ориентированное-программирование-ооп)
      <details>
        ...
        + [2.4.25. Как решается проблема ромбовидного наследования при наследовании интерфейсов с default-методами?](#2425-как-решается-проблема-ромбовидного-наследования-при-наследововании-интерфейсов-с-default-методами)
    ...
    + [2.5. Исключения (Exceptions)](#25-исключения-exceptions)
      <details>
        ...
        + [2.5.10. Что необходимо реализовать для работы try-with-resources (AutoCloseable)?](#2510-что-необходимо-реализовать-для-работы-try-with-resources-autoclosable)
        + [2.5.11. Что произойдет, если исключение будет выброшено из блока catch, а затем другое — из finally?](#2511-что-произойдет-если-исключение-будет-выбросено-из-блока-catch-а-затем-другое-из-finally)
    ...
    + [2.7. Дженерики (Generics)](#27-дженерики-generics)
      <details>
        ...
        + [2.7.7. Что такое рекурсивные дженерики?](#277-что-такое-реккурсивные-дженерики)
