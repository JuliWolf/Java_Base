...
+ [10. Какие бывают ссылки и в чем их отличия](#9-как-работает-g1-gc-garbage-first)
...
+ [45. Какие иммутабульные классы есть в java?](#44-какие-есть-способы-проверки-значения-на-null)
...
+ [14. Как определить причину OutOutMemoryError](#13-можно-ли-использовать-проверяемые-исключения-в-лямбда-функциях)
...
+ [26. Какая структура подходит для хранения большого количества данных](#25-на-чем-основана-hashset)
+ [27. Что может быть ключем в HashMap?](#25-на-чем-основана-hashset)
