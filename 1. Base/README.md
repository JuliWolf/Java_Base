...
+ [9. Какие ошибки отменяют транзакцию?](#8-что-означает-asid)
+ [10. Как удалить все записи из таблицы](#8-что-означает-asid)
+ [11. Как работает while loop](#8-что-означает-asid)
...
+ [11. @PreDestroy что это такое и зачем он нужен](#11-predestroy-что-это-такое-и-зачем-он-нужен)
...
### 16. Какая структура у Spring контейнера
