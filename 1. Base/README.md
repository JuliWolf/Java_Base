...
+ [9. Какой дефолтный оператор доступа у класса](#8-что-такое-пакеты-зачем-они-нужны-какие-пакеты-по-умолчанию-подключены)
+ [10. Какие типы принимает System.out.printLn](#8-что-такое-пакеты-зачем-они-нужны-какие-пакеты-по-умолчанию-подключены)
...
Принимает только примитивы</br>
При передачи объектов, массивов происходит попытка вызвать метод `toString` 
