...
+ [1. Структура производителя](#1-несколько-производителей)
+ [2. Обязательные свойства производителей](#1-несколько-производителей)
+ [3. Пример создания нового производителя](#1-несколько-производителей)
+ [4. Методы отправки сообщений](#1-несколько-производителей)
+ [5. Пример отправки сообщений](#1-несколько-производителей)
+ [6. Синхронная отправка сообщений](#1-несколько-производителей)
+ [7. Типы ошибок в KafkaProducer](#1-несколько-производителей)
+ [8. Асинхронная отправка сообщения](#1-несколько-производителей)
