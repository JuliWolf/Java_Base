...
Первый кзел, создавший контроллер, становится следующим узлом-контроллером<br>
...
- Ведомые - все остальные реплики раздела
  Их основная задача реплицироваь сообщения от ведущей реплики и поддерживать актуальное состояние<br>
  Если реплика не запрашивала сообщения более 10с или заправшивала, но не отстает более чем на 10с, то она считается `расогласованной`<br>
  Если реплика стабильно запраштивает новые собщение, то она считается `согласованной`<br>
