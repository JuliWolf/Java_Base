...
@Getter
@Setter
public class PostCustomViewResponse implements Response {
  ...
  private List<CustomViewHeaderRowName> header_row_names;
  ...
  private List<CustomViewTableColumnName> table_column_names;
