...
@Getter
@Setter
@Table(name = "asset_type_attribute_type_assignment", schema = "public")
public class AssetTypeAttributeTypeAssignment {
  @Id
  @GeneratedValue(strategy = GenerationType.UUID)
  @Column(name = "asset_type_attribute_type_assignment_id", updatable = false, nullable = false)
  ...
  public AssetTypeAttributeTypeAssignment (AssetType assetType, AttributeType attributeType, User createdBy) {
