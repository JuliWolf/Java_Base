...
@Setter
@Getter
public class GetRelationComponentAttributeResponse implements Response {
  ...
  public GetRelationComponentAttributeResponse (RelationComponentAttributeWithConnectedValues relationAttributeWithConnectedValues) {
    this.relation_component_attribute_id = relationAttributeWithConnectedValues.getRelationComponentAttributeId();
    ...
    this.relation_component_id = relationAttributeWithConnectedValues.getRelationComponentId();
