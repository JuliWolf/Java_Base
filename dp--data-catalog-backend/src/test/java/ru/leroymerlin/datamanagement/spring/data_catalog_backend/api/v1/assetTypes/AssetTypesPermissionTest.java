...
public class AssetTypesPermissionTest extends MockPermissionTest {
  ...
  @Test
  public void POST_assetTypes_GlobalResponsibility_ALLOW_ALL () throws JsonProcessingException {
    roleActionCachingService.clearCache();

    PostAssetTypeRequest postRequest = new PostAssetTypeRequest("some new name", null, "desc", "acr", "color", null, null);
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.POST,
      "http://localhost:" + port + "/v1/assetTypes",
      requestBody,
      user
    );
  ...
  @Test
  public void POST_assetTypes_GlobalResponsibility_DENY_ALL () throws JsonProcessingException {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_by_id_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();

    AssetType assetType = assetTypeRepository.save(new AssetType("asset type name", "desc", "acr", "color", language, user));

    roleActionRepository.save(new RoleAction(role, viewActionType, assetTypeEntity, ActionScopeType.ALL, PermissionType.ALLOW, user));

    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.GET,
      "http://localhost:" + port + "/v1/assetTypes/" + assetType.getAssetTypeId(),
      null,
      user
    );
  ...
  @Test
  public void GET_assetTypes_by_id_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_by_id_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_by_id_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_children_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.GET,
      "http://localhost:" + port + "/v1/assetTypes/" + assetType.getAssetTypeId() + "/children",
      null,
      user
    );
  ...
  @Test
  public void GET_assetTypes_children_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_children_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypes_children_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void PATCH_assetTypes_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();

    AssetType assetType = assetTypeRepository.save(new AssetType("asset type name", "desc", "acr", "color", language, user));

    roleActionRepository.save(new RoleAction(role, editActionType, assetTypeEntity, ActionScopeType.ALL, PermissionType.ALLOW, user));

    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.PATCH,
      "http://localhost:" + port + "/v1/assetTypes/" + assetType.getAssetTypeId(),
      "{\"asset_type_name\": \"another name\"}",
      user
    );
  ...
  @Test
  public void PATCH_assetTypes_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();

    AssetType assetType = assetTypeRepository.save(new AssetType("asset type name", "desc", "acr", "color", language, user));

    roleActionRepository.save(new RoleAction(role, editActionType, assetTypeEntity, ActionScopeType.ALL, PermissionType.DENY, user));
  ...
  @Test
  public void PATCH_assetTypes_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_assetType () {
    roleActionCachingService.clearCache();

    AssetType assetType = assetTypeRepository.save(new AssetType("asset type name", "desc", "acr", "color", language, user));

    roleActionRepository.save(new RoleAction(role, editActionType, assetTypeEntity, ActionScopeType.ALL, PermissionType.ALLOW, user));
    RoleAction roleAction = new RoleAction(role, editActionType, assetTypeEntity, ActionScopeType.ONE_ID, PermissionType.DENY, user);
    roleAction.setAssetType(assetType);
    roleActionRepository.save(roleAction);
  ...
  @Test
  public void PATCH_assetTypes_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_assetType () {
    roleActionCachingService.clearCache();

    AssetType assetType = assetTypeRepository.save(new AssetType("asset type name", "desc", "acr", "color", language, user));

    roleActionRepository.save(new RoleAction(role, editActionType, assetTypeEntity, ActionScopeType.ALL, PermissionType.DENY, user));
    RoleAction roleAction = new RoleAction(role, editActionType, assetTypeEntity, ActionScopeType.ONE_ID, PermissionType.ALLOW, user);
    roleAction.setAssetType(assetType);
    roleActionRepository.save(roleAction);
  ...
  @Test
  public void DELETE_assetTypes_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_assetTypes_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_assetTypes_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_assetTypes_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
