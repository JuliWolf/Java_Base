...
public class RelationComponentTypeComponentAssetTypesAssignmentsPermissionTest extends MockPermissionTest {
  @Autowired
  ...
  @Test
  public void POST_relationTypeComponentAssetType_GlobalResponsibility_ALLOW_ALL () throws JsonProcessingException {
    roleActionCachingService.clearCache();

    List<PostRelationTypeComponentAssetTypeRequest> allowedAssetTypes = new ArrayList<>();
    allowedAssetTypes.add(new PostRelationTypeComponentAssetTypeRequest(assetType.getAssetTypeId().toString()));

    PostRelationTypeComponentAssetTypesRequest postRequest = new PostRelationTypeComponentAssetTypesRequest(allowedAssetTypes);
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.POST,
      "http://localhost:" + port + "/v1/assignments/relationTypeComponent/" + relationTypeComponent.getRelationTypeComponentId() + "/asset_type/batch",
      requestBody,
      user
    );
  ...
  @Test
  public void POST_relationTypeComponentAssetType_GlobalResponsibility_DENY_ALL () throws JsonProcessingException {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void POST_relationTypeComponentAssetType_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_relationType () throws JsonProcessingException {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void POST_relationTypeComponentAssetType_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_relationType () throws JsonProcessingException {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_relationTypeComponentAssetType_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.GET,
      "http://localhost:" + port + "/v1/assignments/relationTypeComponent/" + relationTypeComponent.getRelationTypeComponentId() + "/assetType",
      null,
      user
    );
  ...
  @Test
  public void GET_relationTypeComponentAssetType_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_relationTypeComponentAssetType_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_relationType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_relationTypeComponentAssetType_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_relationType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_relationTypeComponentAssetType_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();

    RelationTypeComponentAssetTypeAssignment relationTypeComponentAssetTypeAssignment = relationTypeComponentAssetTypeAssignmentRepository.save(new RelationTypeComponentAssetTypeAssignment(relationTypeComponent, assetType, false, null, user));
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.DELETE,
      "http://localhost:" + port + "/v1/assignments/relationTypeComponent/assetType/" + relationTypeComponentAssetTypeAssignment.getRelationTypeComponentAssetTypeAssignmentId(),
      null,
      user
    );
  ...
  @Test
  public void DELETE_relationTypeComponentAssetType_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_relationTypeComponentAssetType_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_relationType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_relationTypeComponentAssetType_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_relationType () {
    roleActionCachingService.clearCache();
