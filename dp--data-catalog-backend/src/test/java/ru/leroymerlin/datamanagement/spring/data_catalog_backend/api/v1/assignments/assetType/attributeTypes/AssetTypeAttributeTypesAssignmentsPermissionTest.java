...
public class AssetTypeAttributeTypesAssignmentsPermissionTest extends MockPermissionTest {
  @Autowired
  protected AssetTypeAttributeTypeAssignmentRepository assetTypeAttributeTypeAssignmentRepository;
  ...
  @Test
  public void POST_assetTypeAttributeType_GlobalResponsibility_ALLOW_ALL () throws JsonProcessingException {
    roleActionCachingService.clearCache();

    List<PostAssetTypeAttributeTypeAssignmentRequest> statusAssignments = new ArrayList<>();
    statusAssignments.add(new PostAssetTypeAttributeTypeAssignmentRequest(attributeType.getAttributeTypeId()));

    PostAssetTypeAttributeTypesAssignmentsRequest postRequest = new PostAssetTypeAttributeTypesAssignmentsRequest(statusAssignments);
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.POST,
      "http://localhost:" + port + "/v1/assignments/assetType/" + assetType.getAssetTypeId() + "/attribute_type/batch",
      requestBody,
      user
    );
  ...
  @Test
  public void POST_assetTypeAttributeType_GlobalResponsibility_DENY_ALL () throws JsonProcessingException {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void POST_assetTypeAttributeType_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_assetType () throws JsonProcessingException {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void POST_assetTypeAttributeType_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_assetType () throws JsonProcessingException {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypeAttributeType_by_id_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.GET,
      "http://localhost:" + port + "/v1/assignments/assetType/" + assetType.getAssetTypeId() + "/attribute_type",
      null,
      user
    );
  ...
  @Test
  public void GET_assetTypeAttributeType_by_id_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypeAttributeType_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypeAttributeType_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void GET_assetTypeAttributeTypeAssignments_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.GET,
      "http://localhost:" + port + "/v1/assignments/assetTypes/attributeTypes",
      null,
      user
    );
  ...
  @Test
  public void GET_assetTypeAttributeTypeAssignments_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_assetTypeAttributeType_GlobalResponsibility_ALLOW_ALL () {
    roleActionCachingService.clearCache();
    ...
    HttpRequestResponse request = httpRequestUtilsStub.createRequest(
      RequestType.DELETE,
      "http://localhost:" + port + "/v1/assignments/assetType/attributeType/" + assignment.getAssetTypeAttributeTypeAssignmentId(),
      null,
      user
    );
  ...
  @Test
  public void DELETE_assetTypeAttributeType_GlobalResponsibility_DENY_ALL () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_assetTypeAttributeType_GlobalResponsibility_ALLOW_ALL_DENY_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
  ...
  @Test
  public void DELETE_assetTypeAttributeType_GlobalResponsibility_DENY_ALL_ALLOW_ONE_ID_assetType () {
    roleActionCachingService.clearCache();
